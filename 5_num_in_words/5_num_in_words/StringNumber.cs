    ...
    public static class StringNumber
    {
        ...
        private static string HundredsBuilder(long num, long N)
        {
            switch (N)
            {
                ...
                case (1):
                    // return Units(num);
                    return _numbersDictionary[num](num.ToString().Length);
                case (2):
                    if (num < 20)
                        return _numbersDictionary[num](num.ToString().Length);
                    else return _numbersDictionary[num % 100 / 10 * 10](num.ToString().Length) + " " + _numbersDictionary[num % 10](num.ToString().Length);
                case (3):
